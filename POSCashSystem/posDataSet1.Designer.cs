...
namespace POSCashSystem {
    ...
    public partial class posDataSet : global::System.Data.DataSet {
        ...
        public partial class itemsDataTable : global::System.Data.TypedTableBase<itemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public itemsRow AdditemsRow(string name, string price, string description, string quantity) {
...
namespace POSCashSystem.posDataSetTableAdapters {
    ...
    public partial class itemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `items` WHERE ((`id` = @p1) AND ((@p2 = 1 AND `name` IS NULL) OR (`name` = @p3)) AND ((@p4 = 1 AND `price` IS NULL) OR (`price` = @p5)) AND ((@p6 = 1 AND `description` IS NULL) OR (`description` = @p7)) AND ((@p8 = 1 AND `quantity` IS NULL) OR (`quantity` = @p9)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `items` (`name`, `price`, `description`, `quantity`) VALUES (@p1, @p2" +
                ", @p3, @p4)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `items` SET `name` = @p1, `price` = @p2, `description` = @p3, `quantity` = @p4 WHERE ((`id` = @p5) AND ((@p6 = 1 AND `name` IS NULL) OR (`name` = @p7)) AND ((@p8 = 1 AND `price` IS NULL) OR (`price` = @p9)) AND ((@p10 = 1 AND `description` IS NULL) OR (`description` = @p11)) AND ((@p12 = 1 AND `quantity` IS NULL) OR (`quantity` = @p13)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::POSCashSystem.Properties.Settings.Default.posConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `name`, `price`, `description`, `quantity` FROM `items`";
